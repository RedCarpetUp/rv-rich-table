...
class GridComponent extends Component {
    ...
    onDrag(index, e, ui) {
        const newColumnWidths = [...this.props.columnWidths];

        newColumnWidths[index] = Math.max(
            this.props.columnWidths[index] + (ui.deltaX), this.state.minColWidth);
        // update new columnsWidth Values dont store in state
        // this.setState({
    ...
    handlHeaderClick = (columnIndex, e) => {
        ...
        if (this.state[`head-${columnIndex}`] == 'true') {
            ...
            // update location and receive props in parent component
            this.props.history.push(`/profiles/${this.state.page}/followers/asc${qs}`)
        //     appState.getTableList({
        //         type: 'sort', page: this.state.page,
    ...
    headerCellRenderer(scrollToColumn, scrollToRow, {columnIndex, key, rowIndex, style}) {
        ...
        return (
            ...
            >
                ...
                >
                    {
                        this.props.columnName[columnIndex]
                    }
                    {columnIndex == 3 &&
    ...
    handlePaste = (rowIndex, columnIndex, e) => {
        ...
        this.props.updateTable(rowIndex, columnIndex, parsed)
    }

    handleCopy = (rowIndex, e) => {
        const list = this.props.tableList;
    ...
    handleCopyCell = (rowIndex, columnIndex, e) => {
        const tableList = this.props.tableList;
        const string = tableList[rowIndex][this.props.columns[columnIndex]];
    ...
    handleClickId = (rowIndex, e) => {
        ...
        this.props.updateDropdown(rowIndex, true);
        this.setState({
    ...
    cellRenderer(scrollToColumn, scrollToRow, {columnIndex, key, rowIndex, style}) {
        const tableList = this.props.tableList;
        const columnName = this.props.columnName[columnIndex];
            ...
            <div>
                <div key={key}>
                    ...
                    >
                        ...
                        {columnName == ' ' &&
                        <div onClick={this.handleSelectClick.bind(this, rowIndex)}
                             onCopy={this.handleCopy.bind(this, rowIndex)} className="cell-div22">
                            <span>{rowIndex + 1}</span>
                        </div>
                        }
                        {columnName == 'Id' &&
                        <div
                            onMouseEnter={this.handleTooltip.bind(this, tableList[rowIndex][this.props.columns[columnIndex]])}
                            onMouseLeave={this.handleTooltipOut}
                            onCopy={this.handleCopyCell.bind(this, rowIndex, columnIndex)} className={hgbg}>
                            ...
                            <div style={{textAlign: 'left'}}
                                ...
                                <span>{tableList[rowIndex][this.props.columns[columnIndex]]}</span>
                            </div>
                            }
                        ...
                        <div onCopy={this.handleCopyCell.bind(this, rowIndex, columnIndex)} className={hgbg}>
                            ...
                            <img
                                ...
                                src={tableList[rowIndex][this.props.columns[columnIndex]]}/>
                            }
                        ...
                        {columnName == 'Name' &&
                        <div
                            onMouseEnter={this.handleTooltip.bind(this, this.state[`cell-edit-${rowIndex}-${columnIndex}`] || tableList[rowIndex][this.props.columns[columnIndex]])}

                            onMouseLeave={this.handleTooltipOut} className={'cell-div2 ' + hgbg}
                            style={{paddingTop: '4px'}} onCopy={this.handleCopyCell.bind(this, rowIndex, columnIndex)}>
                            {idRow &&
                            <div id={`cell-edit-${rowIndex}-${columnIndex}`}
                                 className={isClick ? 'cell-wrap active-cell' : 'cell-wrap'}>
                                <input className="editing-cell" type="text"
                                       defaultValue={tableList[rowIndex][this.props.columns[columnIndex]]}
                                       value={this.state[`cell-edit-${rowIndex}-${columnIndex}`]}
                                       onChange={this.handlChange.bind(this, rowIndex, columnIndex)}/>
                            </div>
                            }
                            {!idRow &&
                            <span>{this.state[`cell-edit-${rowIndex}-${columnIndex}`] || tableList[rowIndex][this.props.columns[columnIndex]]}</span>
                            }
                            {tableList[rowIndex]['repoName'] &&
                            <div className="cell-div22">
                        ...
                        <div className={'cell-div2 ' + hgbg}>
                            ...
                            <div>
                                ...
                                <Button className="create-app-btn"
                                        onClick={this.handleClickShowDetails.bind(this, rowIndex)}>
                                    Show Details
                                </Button>
                            </div>
                            }
    ...
    render() {
        // const {appState, match} = this.props;
        const {isClickable, mode, scrollToColumn, scrollToRow, columns} = this.props;
        return (
            <div className="table-cont" id="table-cont">
                <ArrowKeyStepper
                    ...
                    mode={mode}
                    rowCount={this.props.tableList.length}
